...
var gFeaturesView = {
  ...
  getExisting: function(){
    return new Promise(function(resolve, reject){
      AddonManager.getAllAddons(function(all){
        ...
        var extensions = all.filter(function(addon){ return addon.type == "extension" && addon.hidden == false; });
  ...
  //avoid fetching it multiple times from the backend
  available: null,
